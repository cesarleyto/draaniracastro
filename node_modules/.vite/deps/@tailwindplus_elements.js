...
if (typeof globalThis.window < "u") {
  ...
  document.addEventListener("submit", (o) => {
    ...
    if (t && t.method === "dialog") {
      ...
      let r = o.submitter?.value ?? "", i = n.beforeClose(r);
      if (i === true || (o.preventDefault(), o.stopImmediatePropagation(), i === false)) return;
      i.then((s) => {
        s && (e = true, t.dispatchEvent(o));
      }).catch(console.error);
    }
  }, true);
}
...
var He = null;
typeof globalThis.window < "u" && (He = HTMLDialogElement.prototype.close, Object.defineProperties(HTMLDialogElement.prototype, { close: { value(e) {
  let o = this.closest("el-dialog");
  if (!(o instanceof Re)) return He?.call(this, e);
  let t = o.beforeClose(e);
  if (t === true) return He?.call(this, e);
  t !== false && t.then((n) => n ? He?.call(this, e) : null).catch(console.error);
  ...
  let n = e.source?.tagName === "BUTTON" ? e.source.value : void 0, r = t.beforeClose(n);
  r !== true && (e.stopImmediatePropagation(), e.preventDefault(), r !== false && r.then((i) => i ? He?.call(o, n) : null).catch(console.error));
}, true));
var Q;
var oe;
var Be;
...
var Re = class extends A {
  ...
  beforeClose(t) {
    ...
    let n = d(this, Q).signal;
    return new Promise((r) => {
      d(this, ye)?.start("out", () => {
        n.aborted || (I(this, Q, null), requestAnimationFrame(() => {
          let i = this.getNativeDialog(), s = i.style.cssText;
          i.style.cssText = s + "transition-duration: 0 !important;", He?.call(i, t), requestAnimationFrame(() => {
            i.style.cssText = s;
          });
        }), r(true));
      });
